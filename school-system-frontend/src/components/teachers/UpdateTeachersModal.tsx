...
import { useUpdateTeacherMutation } from '../../libs';

import { IUpdateTeacher } from '../../interfaces';
import { UpdateModal } from '../ui/UpdateModal';
import { RootState, closeUpdateModal } from '../../redux';
import { showErrorAlert, showSuccessAlert } from '../helpers';

export const UpdateTeachersModal: FC = () => {
  ...
  const { handleSubmit, register, setValue, formState: { errors }, setError, trigger } = useForm<IUpdateTeacher>();
  ...
  const onSubmit: SubmitHandler<IUpdateTeacher> = async (data) => {
    try {
      await updateTeacher({ id: payload?.id, teacher: data });
  ...
  return (
    <UpdateModal title={'Actualizar Profesor'}>
      <form
        noValidate
        autoComplete='off'
